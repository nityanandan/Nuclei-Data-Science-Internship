...
**Dataset**      
```{r read_data, echo=T}
dfrModel <- read.csv("./R data/titanic-train.csv", header=T, stringsAsFactors=F)
head(dfrModel)
```   
_Observation_   
...
**Test Data**  
```{r test_data, echo=T}
dfrTests <- read.csv("./R data/titanic-check.csv", header=T, stringsAsFactors=F)
